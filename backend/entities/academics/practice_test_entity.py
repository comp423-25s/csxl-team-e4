...
class PracticeTestEntity(EntityBase):
    ...
    instructor_approved: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)


    # Method to convert from a draft or another model into an entity
    @classmethod
    def from_draft(cls, user: str, course: str, user_prompt: str, test_contents: str, created_at: datetime, instructor_approved: bool) -> Self:
